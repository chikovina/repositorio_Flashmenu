...
public class crearBebidas extends Activity{
	...
	//	private static String url_create_Rest = "http://10.40.3.149/PHP/FlashmenuPHP/nuevoMenuRestaurant.php";
		private static String url_create_Rest = "http://201.239.236.147/PHP/FlashmenuPHP/nuevoBebida.php";
		...
		public void onCreate(Bundle savedInstanceState) {
			...
			nom = (EditText) findViewById(R.id.nombreBebida);
			des = (EditText) findViewById(R.id.descripcionBebida);
			precio = (EditText) findViewById(R.id.precioBebida);
			
			
			Button btnCreateRest = (Button) findViewById(R.id.crearBebida);
		...
		class nuevoMenu extends AsyncTask<String, String, String> {
			...
			protected void onPreExecute() {
				super.onPreExecute();
				pDialog = new ProgressDialog(crearBebidas.this);
				pDialog.setMessage("Ingresando Bebida..");
			...
			protected String doInBackground(String... args) {
				...
				params.add(new BasicNameValuePair("Bebidas_nombre", name));
				params.add(new BasicNameValuePair("Bebidas_descripcion", desPlatos));
				params.add(new BasicNameValuePair("Bebidas_precio", prePlatos));
