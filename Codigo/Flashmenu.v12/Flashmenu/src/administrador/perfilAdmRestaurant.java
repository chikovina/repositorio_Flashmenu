...
public class perfilAdmRestaurant extends Activity {
	...
	private ProgressDialog pDialog;
	   ...
	   private static String url_all_inforest = "http://201.239.236.147/PHP/FlashmenuPHP/perfilAdm.php";
	   private static String url_all_rest = "http://201.239.236.147/PHP/FlashmenuPHP/perfilAdm2.php";
...
///////
	...
	public class Loadrest2 extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... args) {
			...
			List<NameValuePair> params = new ArrayList<NameValuePair>();
			params.add(new BasicNameValuePair("buscar", id));
