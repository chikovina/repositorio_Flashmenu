...
<body id="page6">
    ...
    <header>
        ...
        <div class="row-bot">
        	<div class="row-bot-bg">
            	<div class="main">
                	<h2>Modificar <span>productos a la carta</span></h2>
                </div>
            </div>
        </div>
    </header>
    ...
    <section id="content"><div class="ic"></div>
            ...
            <article class="col-2"> 
                   <form class="basic-grey" enctype="multipart/form-data" name="NombreForm" action="modificarProducto.php?<?php echo "idPlatos=".$idPlatos."&idRestaurant=".$idRestaurant."&Rest_nombre=".$Rest_nombre."&Rest_email=".$Rest_email."&var1=".$var1."&admnombre=".$admnombre."&admemail=".$admemail."&admapeP=".$admapeP."&admapeM=".$admapeM?>" onsubmit="return validarVacios();">
                    ...
                    if( $ext_correcta && $tipo_correcto && $tamano <= $limite ){
                        if(is_uploaded_file($_FILES['foto']['tmp_name'])){
                            ...
                            if (move_uploaded_file($_FILES['foto']['tmp_name'], $imagen_subida)) {
                                ...
                                $query = "UPDATE Producto SET Producto_nombre='$nombre', Producto_descripcion='$descripcion', Producto_precio='$precio', Producto_tipo='$tipo', Producto_foto='$imagen_subida', Restaurant_idRestaurant='$idRestaurant', Producto_tipo_idProducto_tipo='$Pro_tipo' WHERE idProducto = $idPlatos";
