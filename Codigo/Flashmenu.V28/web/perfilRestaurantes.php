...
<body id="page5">
    ...
    <section id="content"><div class="ic"></div>
        ...
        <div class="wrapper">
            ...
            <article class="col-2">
                <div class="maxheight indent-bot" style="height: 318px;">
                    <h3 class="p1"><?php echo $Rest_nombre ?></h3>
                        <ul class="list-1">
                            <li><label>Email restaurant: </label><?php echo $Rest_email ?></li>
                            <li><label>Administrador: </label><?php echo $admnombre." ".$admapeP ?></li>
                            <li><label>Email administrador: </label><?php echo $admemail ?></li>
                        </ul>
                </div>
            </article>
