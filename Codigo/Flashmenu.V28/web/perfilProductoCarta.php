 ...
 <div class="wrapper">
                ...
                <h3 class="p1">Perfil</h3>
                    <ul>
                        ...
                        <li><a href='eliminarProducto.php?<?php echo "idPlatos=$idPlatos"?><?php echo "&perfilAdm=$perfilAdm"?><?php echo "&var1=$var1"?>' class="button-2" href="#" onClick="document.getElementById('contact-form').submit()" >Eliminar producto</a></li>
                    </ul>
                </article>
