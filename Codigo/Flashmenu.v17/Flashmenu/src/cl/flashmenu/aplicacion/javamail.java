...
public class javamail {
	...
	public javamail(String vuser, String vpass, String vdestino, String vsubject, String vmensaje, String tipo) {
		user = vuser;
		pass = vpass;
		destino = vdestino;
		subject = vsubject;
		...
		/* el tipo es por si queremos poder enviar a mas de un proveedor de correo, en nuestro caso
		solo usaremos gmail.*/
		switch (tipo) {
		case "gmail":
			setGmailProps();
