...
public class iniciarSesion extends Activity {
	...
	//private static String URL_connect = "http://10.40.3.149/PHP/FlashmenuPHP/iniciarSesion.php";
	private static String URL_connect = "http://201.239.236.147/PHP/FlashmenuPHP/iniciarSesion.php";
