...
public class perfilRestaurant extends Activity {
	...
	String nombreRest, idADM, id2,idREST;
	...
	protected void onCreate(Bundle savedInstanceState) {
	      ...
	      //RECIBIR DATOS POR INTENT
			Bundle extras = getIntent().getExtras();
			        if (extras != null) {
			     	   ...
			     	   nombreRest  = extras.getString("nom");//nombre del restaurant
			     //	    new Loadrest().execute(); 
		...
		ingresarplato.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				i.putExtra("id",idREST);
				
				Toast toast1 = Toast.makeText(getApplicationContext(),idREST, Toast.LENGTH_SHORT);
			      toast1.show();
...
///////
	...
	public class Loadrest extends AsyncTask<String, String, String> {
		...
		protected void onPostExecute(String file_url) {
			...
			Toast toast1 = Toast.makeText(getApplicationContext(),id2, Toast.LENGTH_SHORT);
		      toast1.show();
		}
	}
